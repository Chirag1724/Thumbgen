                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2">
                            <img src="https://yt3.googleusercontent.com/ytc/AIdro_m7MWMBm4PynPndRMCxUEfNcU9Eufkk5ZkYI5RNjPchQ_c=s900-c-k-c0x00ffffff-no-rj" class="rounded-full size-7" />
                            CS50
                        </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2">
                            <img src="https://yt3.googleusercontent.com/ytc/AIdro_lUgoevWNPCGZJowMs4p6mlt8HdQWdBWvKC47sfvAJ16FM=s900-c-k-c0x00ffffff-no-rj" class="rounded-full size-7" />
                            CampusX
                        </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2">
                            <img src="https://yt3.googleusercontent.com/6tLBV-DRVemxhmanuezR5HkHshX2g7Y46Rq8cysyO1V-nd2SaQ2Fi8cdgVM-n6v_8XZ5BEimxXI=s900-c-k-c0x00ffffff-no-rj" class="rounded-full size-7" />
                            Chai aur Code
                        </a>
                        <a class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2">
                            <img src="https://yt3.googleusercontent.com/1gDPO-4YPWFErfn3yQBnv0yxpkmiud1m5CrorApkOqUYdNd9FrZQ9xB9C9VmDt4EsgArnlwqAQc=s900-c-k-c0x00ffffff-no-rj" class="rounded-full size-7" />
                            TEDx Talks
                        </a>
                    </nav>
                </aside>
